...
export default function SimulatePage() {
    ...
    const [sessionConfig, setSessionConfig] = useState<SessionConfig | undefined>(undefined);
    ...
    const [coefficientHistory, setCoefficientHistory] = useState<Array<{
        iteration: number;
        cl: number;
        cd: number;
        cm: number;
    ...
    const { coefficients, isConnected, error: cfdError, closeConnection } = useCFD(sessionConfig);
            ...
            <div className="flex-1 flex overflow-hidden relative bg-gray-50">
                ...
                <div className="flex-1 flex flex-col p-6 gap-4">
                    <div className="flex-1 flex gap-4">
                        ...
                        <div className={`${isSimulating || showResults ? 'w-96' : 'w-80'} flex flex-col gap-4 transition-all duration-300`}>
                                ...
                                <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl border-2 border-cyan-200 p-5 space-y-4 overflow-y-auto">
                                    ...
                                    <div className="space-y-2 text-xs font-medium text-cyan-800">
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-black">{simulationMetrics.cl.toFixed(4)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span>
                                                Drag Coefficient (C<sub>D</sub>):
                                            </span>
                                            <span className="font-black">{simulationMetrics.cd.toFixed(4)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span>L/D Ratio:</span>
                                            <span className="font-black">{simulationMetrics.liftToDragRatio.toFixed(2)}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-3 pt-2 border-t border-cyan-200">
                                        ...
                                        <div>
                                            <div className="flex justify-between text-xs mb-1">
                                                ...
                                                <span className="font-black text-cyan-900">{simulationMetrics.cl.toFixed(4)}</span>
                                            </div>
                                            <div className="w-full bg-cyan-100 rounded-full h-4 overflow-hidden">
                                                <div
                                                    ...
                                                    style={{ width: `${Math.min((Math.abs(simulationMetrics.cl) / 1.2) * 100, 100)}%` }}
                                                >
                                        ...
                                        <div>
                                            <div className="flex justify-between text-xs mb-1">
                                                ...
                                                <span className="font-black text-cyan-900">{simulationMetrics.cd.toFixed(4)}</span>
                                            </div>
                                            <div className="w-full bg-red-100 rounded-full h-4 overflow-hidden">
                                                <div
                                                    ...
                                                    style={{ width: `${Math.min((simulationMetrics.cd / 0.1) * 100, 100)}%` }}
                                                >
                                                    <span className="text-[10px] font-bold text-white">
                                                        Drag
                                                    </span>
                                        ...
                                        <div>
                                            <div className="flex justify-between text-xs mb-1">
                                                ...
                                                <span className="font-black text-cyan-900">{simulationMetrics.liftToDragRatio.toFixed(2)}</span>
                                            </div>
                                            <div className="w-full bg-green-100 rounded-full h-4 overflow-hidden">
                                                <div
                                                    ...
                                                    style={{ width: `${Math.min((simulationMetrics.liftToDragRatio / 50) * 100, 100)}%` }}
                                                >
                                                    <span className="text-[10px] font-bold text-white">
                                                        Efficiency
                                                    </span>
