...
export default function App() {
  ...
  const [selectedTab, setSelectedTab] = useState<'design' | 'optimize' | 'turbine'>('design');
                    ...
                    <div className="p-4">
                      ...
                      <div className="grid grid-cols-4 gap-3">
                        <div className="bg-gray-700 rounded p-3">
                          <div className="text-xs text-gray-400 mb-1">Lift Coefficient</div>
                          <div className="text-lg font-bold text-blue-400">1.198</div>
                        </div>
                        <div className="bg-gray-700 rounded p-3">
                          <div className="text-xs text-gray-400 mb-1">Drag Coefficient</div>
                        ...
                        <div className="bg-gray-700 rounded p-3">
                          <div className="text-xs text-gray-400 mb-1">Moment Coeff.</div>
                          <div className="text-lg font-bold text-purple-400">-0.085</div>
                        </div>
                      </div>
                    </div>
                  )}
